...
public Fine(int id, Vehicle typeVehicle, Plate plate, Date date, String gultyFirstName, String gultyLastName, String comment, Policeman policeman,int validation,ArrayList<Violation> violations) {
	super();
...
public Fine(Vehicle typeVehicle, Plate plate, Date date, String gultyFirstName, String gultyLastName, String comment, Policeman policeman,int validation,ArrayList<Violation> violations) {
	super();
